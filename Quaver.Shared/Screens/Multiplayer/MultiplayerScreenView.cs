    ...
    public class MultiplayerScreenView : ScreenView
    {
        ...
        private void CreateFooter()
        {
            Footer = new MenuFooterMultiplayer(new List<ButtonText>
            {
                ...
                new ButtonText(FontManager.GetWobbleFont(Fonts.InterSemiBold), MultiplayerLocalization.Get("Commands"), 14, (o, e) => BrowserHelper.OpenURL("https://quavergame.com/wiki/Multiplayer/Commands"))
            }, new List<ButtonText>
            {
            }, Colors.MainAccent)
            {
