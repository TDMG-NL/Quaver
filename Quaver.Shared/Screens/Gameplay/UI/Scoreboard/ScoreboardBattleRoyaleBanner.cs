...
namespace Quaver.Shared.Screens.Gameplay.UI.Scoreboard
{
    public class ScoreboardBattleRoyaleBanner : Sprite
    {
        ...
        public ScoreboardBattleRoyaleBanner(Scoreboard scoreboard)
        {
            ...
            PlayersLeft = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), Scoreboard.BattleRoyalePlayersLeft + " Left")
            {
                Parent = this,
            ...
            TimeLeft = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "-00:00", 0, false)
            {
                Parent = this,
                Alignment = Alignment.MidLeft,
                FontSize = 18,
