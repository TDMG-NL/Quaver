...
namespace Quaver.Shared.Screens.Gameplay.UI.Multiplayer
{
    public class BattleRoyalePlayerEliminated : Container
    {
        ...
        public BattleRoyalePlayerEliminated(GameplayScreen screen)
        {
            ...
            Username = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), " ", 0, false)
            {
                Parent = this,
                Tint = Color.Crimson,
                FontSize = 20,
            ...
            Eliminated = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), " has been eliminated!", 0, false)
            {
                Parent = this,
                FontSize = 20,
                X = Username.Width + 1,
