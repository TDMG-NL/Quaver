...
namespace Quaver.Shared.Screens.Theater.UI.Players
{
    public class DrawableReplayPlayer : Sprite
    {
        ...
        {
            PlayerName = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "", 22)
            {
                Parent = this,
                X = 10,
                Y = 12
        ...
        {
            Mods = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "", 22)
            {
                Parent = this,
                X = PlayerName.X
            };
        ...
        {
            PerformanceRating = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "", 22)
            {
                Parent = this,
                X = PlayerName.X
            };
        ...
        {
            Accuracy = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "", 22)
            {
                Parent = this,
                X = PlayerName.X
            };
        ...
        {
            Judgements = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "", 22)
            {
                Parent = this,
                X = PlayerName.X
            };
