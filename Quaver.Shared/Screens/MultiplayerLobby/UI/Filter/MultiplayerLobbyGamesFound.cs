...
namespace Quaver.Shared.Screens.MultiplayerLobby.UI.Filter
{
    public class MultiplayerLobbyGamesFound : Container
    {
        ...
        {
            TextCount = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "0", 20)
            {
                Parent = this,
        ...
        {
            TextMatchesFound = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), MultiplayerLobbyLocalization.Get("GamesFound"), 20)
            {
                Parent = this,
