...
namespace Quaver.Shared.Graphics.Overlays.Hub.SongRequests.Scrolling
{
    public class DrawableSongRequest : PoolableSprite<SongRequest>
    {
        ...
        {
            ArtistTitle = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), " ", 22)
            {
                Parent = this,
        ...
        {
            Difficulty = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "", 20)
            {
                Parent = Icon,
        ...
        {
            Username = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "", 20)
            {
                Parent = Icon,
                Alignment = Alignment.MidLeft,
