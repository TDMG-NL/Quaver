...
namespace Quaver.Shared.Graphics.Dialogs.Online
{
    public class LegalAcceptanceDialog : YesNoDialog
    {
            ...
            $"By clicking \"Accept\", You acknowledge that\nyou have read and agree to the\n{name}.")
        {
            ...
            var legalText = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), text, 18, true)
            {
            ...
            YesButton.SetLabel(FontManager.GetWobbleFont(Fonts.InterSemiBold), "ACCEPT", 18, Color.White);
            NoButton.SetLabel(FontManager.GetWobbleFont(Fonts.InterSemiBold), "DECLINE", 18, Color.White);
