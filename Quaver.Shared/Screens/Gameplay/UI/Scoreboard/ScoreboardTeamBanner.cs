...
namespace Quaver.Shared.Screens.Gameplay.UI.Scoreboard
{
    public class ScoreboardTeamBanner : Sprite
    {
        ...
        public ScoreboardTeamBanner(Scoreboard scoreboard)
        {
            ...
            Points = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "0")
            {
            ...
            TeamRating = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "0.00", 0, false)
            {
