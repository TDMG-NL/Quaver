...
namespace Quaver.Shared.Screens.MultiplayerLobby.UI.Selected
{
    public class SelectedGamePanel : Sprite
    {
        ...
        {
            Header = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterBold), MultiplayerLobbyLocalization.Get("MatchDetails"), 26)
            {
                Parent = this,
        ...
        {
            SubHeader = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), MultiplayerLobbyLocalization.Get("ViewInformationAboutMatch").ToUpper(), 16)
            {
                Parent = this,
