...
namespace Quaver.Shared.Graphics.Overlays.Hub.Downloads.Scrolling
{
    public sealed class DrawableDownload : PoolableSprite<MapsetDownload>
    {
        ...
        {
            Name = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "Name", 20)
            {
                Parent = ContentContainer,
            ...
            By = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), " by ", 20)
            {
                Parent = ContentContainer,
                Alignment = Alignment.TopLeft,
            ...
            Artist = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "Artist", 20)
            {
                Parent = ContentContainer,
                Alignment = Alignment.TopLeft,
        ...
        {
            Title = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "", 22)
            {
                Parent = ContentContainer,
                Alignment = Alignment.TopLeft,
                Position = new ScalableVector2(18, 20),
        ...
        {
            ProgressPercentage = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "0%", 20)
            {
                Parent = ContentContainer,
                Alignment = Alignment.TopRight,
