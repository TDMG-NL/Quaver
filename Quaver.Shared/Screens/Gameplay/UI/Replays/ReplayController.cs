...
namespace Quaver.Shared.Screens.Gameplay.UI.Replays
{
    public class ReplayController : DraggableButton
    {
        ...
        {
            CurrentTime = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "00:00:00", 22)
            {
                Parent = SongTimeProgressBar,
                Alignment = Alignment.TopLeft,
                Y = -10
        ...
        {
            TimeLeft = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "-00:00:00", 22)
            {
                Parent = SongTimeProgressBar,
        ...
        {
            F1ToHide = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "PRESS F1 TO SHOW/HIDE", 20)
            {
                Parent = this,
                Alignment = Alignment.TopRight,
                Y = -12
