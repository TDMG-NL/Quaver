...
namespace Quaver.Shared.Screens.Selection.UI.Profile
{
    public class LocalProfileContainer : Sprite
    {
        ...
        {
            Header = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterBold), "PROFILE", 28)
            {
                Parent = this,
        ...
        {
            StatusText = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "", 18)
            {
                Parent = BackgroundContainer,
                Alignment = Alignment.MidCenter,
                Alpha = 0
