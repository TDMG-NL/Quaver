...
namespace Quaver.Shared.Screens.Selection.UI.Modifiers
{
    public class ModifierSelectorContainer : Sprite
    {
        ...
        {
            Header = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterBold), "MODIFIERS", 24)
            {
                Parent = this,
        ...
        {
            SubHeader = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "Customize gameplay to your heart's desire".ToUpper(), 16)
            {
                Parent = this,
