...
public class EpilepsyWarning : Sprite
{
    ...
    private void CreateTitle() =>
        new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "WARNING!", 28)
        {
            Parent = this,
            Alignment = Alignment.MidCenter,
    ...
    private void CreateBody() =>
        new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), WarningBody, 22)
        {
            Parent = this,
            Alignment = Alignment.MidCenter,
            MaxWidth = 1720,
