    ...
    public class DrawableListenerList : Sprite
    {
        ...
        private void CreateHeader()
        {
            ...
            HeaderText = new IconTextButton(FontAwesome.Get(FontAwesomeIcon.fa_music_headphones),
                FontManager.GetWobbleFont(Fonts.InterSemiBold), "LISTENING PARTY", null, Color.White, Color.White)
            {
            ...
            ListenerCount = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.InterSemiBold), "0/16", 22)
            {
                Parent = HeaderBackground,
